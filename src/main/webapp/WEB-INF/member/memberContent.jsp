	...
	<div class="container">
		...
		<div class="panel panel-default">
			...
			<div class="panel-footer" style="text-align: center;">
				...
				<input type="button" value="취소" class='btn btn-warning' onclick="frmreset()" /> <input type="button" value="리스트"
					onclick="location.href='${ctx}/memberList.do'" class='btn btn-success' />
			</div>
		</div>
	</div>
</body>
